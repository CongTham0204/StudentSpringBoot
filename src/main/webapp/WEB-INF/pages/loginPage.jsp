            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <form class="user" name='f' action="/j_spring_security_check" method='POST'>
                    <div class="form-group">
                      <input type="text" name='username' class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Nhập số điện thoại...">
                    </div>
                    <div class="form-group">
